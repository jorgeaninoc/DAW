...
function changeDisplay(){
    if(document.getElementById("empleadoTable").getAttribute("style")=="display: none;")
        document.getElementById("empleadoTable").setAttribute("style", "display: block;");
    else
        document.getElementById("empleadoTable").setAttribute("style", "display: none;");
    for(var i=1; i<empleadoTable.rows.length; i++){

        empleadoTable.rows[i].onclick = function(){
...
if(document.getElementById("empleadoTable")!=null){
    document.getElementById("empleadoTable").setAttribute("style", "display: none;");
    document.getElementById("buscarVisitante").onclick=changeDisplay;
    empleadoTable = document.getElementById("empleadoTable");
}
...
if(document.getElementById("sanctionTable")!=null){
    ...
    empleadoTable = document.getElementById("sanctionTable");
}

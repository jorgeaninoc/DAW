    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <img src="uploads//' .basename( $_FILES["fileToUpload"]["name"]).'" alt="No subiste ninguna imagen.">
        ...
        <div class="modal-footer">
          <div class="row">
            <div class="col-sm-6 text-left">
              <button type="button" action="<?php session_unset(); session_destroy();?>" class="btn btn-danger" data-dismiss="modal">Cancelar</button>
            </div>
            <div class="col-sm-6 text-right">
              <button type="button" action="<?php session_start();?>" class="btn btn-success" data-dismiss="modal">Aceptar</button>
            </div>
          </div>
        </div>
